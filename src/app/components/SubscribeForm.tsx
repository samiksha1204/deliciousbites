...
export default function SubscribeForm() {
  return (
    <div className="mt-6 flex gap-x-4 mb-6">
      ...
      <button
        type="submit"
        className="flex-none rounded-md bg-red-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-texts focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
      >
        Subscribe
      </button>
    </div>
